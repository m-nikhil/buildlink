...
const seedProfiles = [
  ...
  { full_name: 'James Wilson', email: 'james.w@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400', headline: 'Data Scientist', bio: 'ML enthusiast turning data into insights. Looking to connect with product teams and fellow data professionals.', location: 'Boston, MA', experience_level: 'mid', industry: 'tech', looking_for: ['collaboration', 'job_seeking'], looking_for_text: 'Exploring ML engineering roles at mission-driven companies. Open to collaborating on interesting data projects.', skills: ['Python', 'Machine Learning', 'SQL', 'TensorFlow'], age: 31 },
  { full_name: 'Lisa Thompson', email: 'lisa.t@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', headline: 'Healthcare Consultant', bio: 'Helping healthcare organizations transform digitally. Passionate about improving patient outcomes.', location: 'Chicago, IL', experience_level: 'senior', industry: 'healthcare', looking_for: ['networking', 'collaboration'], looking_for_text: 'Looking to connect with health-tech founders and other consultants in the digital health space.', skills: ['Healthcare IT', 'Project Management', 'Change Management', 'HIPAA'], age: 35 },
  { full_name: 'Alex Rivera', email: 'alex.r@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400', headline: 'Junior Developer', bio: 'Recent bootcamp grad eager to learn and grow. Looking for mentorship and entry-level opportunities.', location: 'Denver, CO', experience_level: 'entry', industry: 'tech', looking_for: ['mentorship', 'job_seeking'], looking_for_text: 'Seeking a patient mentor who can help me grow as a developer. Open to junior roles and internships.', skills: ['JavaScript', 'React', 'CSS', 'Git'], age: 24 },
  { full_name: 'Nicole Zhang', email: 'nicole.z@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400', headline: 'Financial Analyst', bio: 'Numbers tell stories. 5 years in investment banking, now exploring fintech opportunities.', location: 'San Francisco, CA', experience_level: 'mid', industry: 'finance', looking_for: ['networking', 'job_seeking'], looking_for_text: 'Interested in fintech product roles that combine my finance background with technology. Love meeting other career changers.', skills: ['Financial Modeling', 'Valuation', 'Excel', 'Bloomberg'], age: 28 },
  { full_name: 'Michael Brown', email: 'michael.b@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400', headline: 'Education Technology Lead', bio: 'Reimagining how we learn. Building tools that make education accessible to everyone.', location: 'Portland, OR', experience_level: 'senior', industry: 'education', looking_for: ['hiring', 'collaboration'], looking_for_text: 'Hiring curriculum designers and engineers passionate about education. Also seeking partnerships with schools.', skills: ['EdTech', 'Curriculum Design', 'LMS', 'Instructional Design'], age: 36 },
];
