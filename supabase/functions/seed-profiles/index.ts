...
const seedProfiles = [
  ...
  { full_name: 'Lisa Thompson', email: 'lisa.t@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', headline: 'Healthcare Consultant', bio: 'Helping healthcare organizations transform digitally. Passionate about improving patient outcomes.', location: 'Chicago, IL', experience_level: 'senior', industry: 'healthcare', looking_for: ['networking', 'collaboration'], skills: ['Healthcare IT', 'Project Management', 'Change Management', 'HIPAA'], age: 35 },
  ...
  { full_name: 'Michael Brown', email: 'michael.b@buildlink.test', avatar_url: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400', headline: 'Education Technology Lead', bio: 'Reimagining how we learn. Building tools that make education accessible to everyone.', location: 'Portland, OR', experience_level: 'senior', industry: 'education', looking_for: ['hiring', 'collaboration'], skills: ['EdTech', 'Curriculum Design', 'LMS', 'Instructional Design'], age: 36 },
];
